        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-4 px-3 py-1 bg-blue-600 text-white text-xs font-semibold rounded-full">v2.012</span>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-lg transition-all duration-300">
            ...
            <div className="space-y-3 mb-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="px-2 py-1 bg-gray-100 text-gray-800 rounded text-xs font-medium">v2.012</span>
              </div>
            </div>
