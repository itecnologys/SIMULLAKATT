      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-800 mb-4">Simulak</h1>
            <h2 className="text-2xl font-semibold text-gray-700 mb-4">
              Plataforma Avançada de Simulação Financeira
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              Simule investimentos, gerencie portfólios e analise mercados.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                onClick={() => document.getElementById('main-content')?.scrollIntoView({ behavior: 'smooth' })}
                className="bg-gray-800 text-white hover:bg-gray-700 px-8 py-3"
              >
                Começar Simulação
              </Button>
              <Button 
